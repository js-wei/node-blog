...
router.all('/status',(req,res)=>{
    ...
    switch (p.type) {
      ...
      case 'delete-all':
        ...
        break;
      case 'enable'://启用
        model.update({_id:p.id},{status:false},(e,i)=>{
          if(e){
              console.log(e);
          }
        ...
        break;
      case 'forbidden'://禁用
        model.update({_id:p.id},{status:true},(e,i)=>{
          if(e){
              console.log(e);
          }
